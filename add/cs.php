        ...
        <div class="form-inner-cont">
          <form  method="post" class="signin-form">
            ...
            <div class="form-input">
              ...
              <input type="text" name="pname" id="w3lName" value="Combo Saree's" placeholder="Product" required="" />
            </div>
            <div class="form-input">
              <label for="w3lName">Product Price</label>
              <input type="text" name="price" id="price" value="1500" placeholder="Price" onchange="total()"  required="" />
            </div>
            <div class="form-input">
