        ...
        <div class="form-inner-cont">
          <form  method="post" class="signin-form">
            ...
            <div class="form-input">
              ...
              <input type="text" name="pname" id="w3lName" value="Warli Artifact's on wall" placeholder="Product" required="" />
            </div>
            <div class="form-input">
              <label for="w3lName">Product Price</label>
              <input type="text" name="price" id="price" value="650" placeholder="Price" onchange="total()"  required="" />
            </div>
            <div class="form-input">
            ...
            <button class="btn" name="pay">Proceed to Pay</button>
          </form>
        </div>
      </div>
    </div>
