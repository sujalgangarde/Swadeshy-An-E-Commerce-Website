        ...
        <div class="form-inner-cont">
          <form action="https://sendmail.w3layouts.com/submitForm" method="post" class="signin-form">
            ...
            <div class="form-input">
              ...
              <input type="text" name="w3lSubject" id="w3lSubject" placeholder="Enter Number" required />
            </div>
            <div class="form-input">
            ...
            <div class="form-input">
              ...
              <textarea name="w3lMessage" id="w3lMessage" placeholder="Enter your Address" required=""></textarea>
            </div>
            <div class="form-input">
              <label for="w3lName">Product Name</label>
              <input type="text" name="w3lName" id="w3lName" placeholder="Product" required="" />
            </div>
            <div class="form-input">
              <label for="w3lName">Product Price</label>
              <input type="text" name="w3lName" id="w3lName" placeholder="Price" required="" />
            </div>
