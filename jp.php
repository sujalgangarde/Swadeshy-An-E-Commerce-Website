		...
		<div class="container">
			<div class="col-md-9 product1">
				<div class=" bottom-product">
					<div class="col-md-6 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="jpb1.php"><img class="img-responsive" src="images/p1.jpg" alt="">
							<div class="pro-grid">
										<span class="buy-in">Buy Now</span>
							</div>
						</a>	
						</div>
						<p class="tun"><span>Floral Plates</span><br>Jaipur Blue Pottery Decorative Plate</p>
						<div class="ca-rt">
							<a href="#" class="item_add"><p class="number item_price"><i> </i>200.00</p></a>						
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-6 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="jpb2.php"><img class="img-responsive" src="images/p2.png" alt="">
							<div class="pro-grid">
										<span class="buy-in">Buy Now</span>
							</div>
						</a>	
						</div>
						<p class="tun"><span>Decorative Pot</span><br>Jaipur Blue Pottery Decorative Pots</p>
						<div class="ca-rt">
				...
				<div class=" bottom-product">
					<div class="col-md-6 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="jpb3.php"><img class="img-responsive" src="images/p3.png" alt="">
							<div class="pro-grid">
										<span class="buy-in">Buy Now</span>
							</div>
						</a>	
						</div>
						<p class="tun"><span>Floral/Show Vase</span><br>Jaipur Blue Pottery Decorative Vase</p>
						<div class="ca-rt">
					...
					<div class="col-md-6 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							<a href="jpb4.php"><img class="img-responsive" src="images/p4.png" alt="">
							<div class="pro-grid">
										<span class="buy-in">Buy Now</span>
							</div>
						</a>	
						</div>
						<p class="tun"><span>Dark Red Pot</span><br>Jaipur Blue Pottery Decorative Pots</p>
						<div class="ca-rt">
			...
			<div class="col-md-3 prod-rgt">
				<div class=" pro-tp">
					<div class="pl-rgt">
						<h6><a href="jp.php" style="font-size: 20px; font-family: 'Mada', sans-serif;">About Jaipur Pottery</a></h6>
						<p><a href="jp.php">Blue Pottery is widely recognized as a traditional craft of Jaipur of Central Asian origin. The name 'blue pottery' comes from the eye-catching cobalt blue dye used to color the pottery. It is one of many Eurasian types of blue and white pottery.Jaipur blue pottery has strong influences of the Persian ceramic style but it has developed its own designs and motifs. Inspired more from nature, the pottery is adorned with profusely animals, birds and flowers with a hint of Persian geometric design in the compositions. Some of this pottery is semi-transparent and mostly decorated with Mughal arabesque patterns and bird and other animal motifs. Thus, the semi-transparent pottery has a gentle mix of Mughal arabesque patterns with bird and other animal motifs forbidden in Persian art of Islamic origin.</a></p>
					</div>
						<div class="clearfix"></div>
				</div>
				<!--<div class=" pro-tp">
